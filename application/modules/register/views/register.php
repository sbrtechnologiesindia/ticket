...
unset($_SESSION['register_success']);
 ...
 <div id="login">
	...
	{
        ?>
        <p><label for="password">Mobile No.</label></p>
        <p>
  ...
  <select id="mcode" style="width:160px;border:0;">
     ...
     <option value="263">Zimbabwe (+263)
        ...
        <input type="text" id="mobilenumber"  value="" size="10" style="width:100px;" > <a class="btn-verify" href="javascript:void(0);" id="mobileverify">Verify</a></p>
        <input type="hidden" name="user_mobile" id="user_mobile" value="">
        <?php
        }
        ?>
        <?php
         $settings = getSettingsValue('register');
         $captcha = getSettingsValue('reCAPTCHA');
         ?> 
        <p>
