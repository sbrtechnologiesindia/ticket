           ...
           <p></span><?php echo $this->lang->line('Ticket No');?>:<?=$det->ticket_no;?></p>
              ...
              <div class="t_view_left clearfix"> 
               ...
               <tr>
                 ...
                 <tr>
                   <td><?php echo $this->lang->line('Department');?></td><td>:</td><td><?= getDepartmentById($det->department_id,'department_name');?></td>
                 </tr> 
                 <tr>
                   <td><?php echo $this->lang->line('Product');?></td><td>:</td><td><?= getProductById($det->product_id,'product_name');?></td>
                 </tr>
                 <tr>
                 ...
                 <tr>
                  ...
                  <tr>
                   <td><?php echo $this->lang->line('State');?></td><td>:</td><td><?= getTicketStateByCode($det->state,'name') ?></td>
                 </tr>  
               </table>
              </div>
              <div class="t_view_right clearfix"> 
               ...
               <tr>
                 ...
                 <tr>
                   <td>Department</td><td>:</td><td><?= getDepartmentById($det->department_id,'department_name');?></td>
                 </tr> 
                 <tr>
                   <td>Product</td><td>:</td><td><?= getProductById($det->product_id,'product_name');?></td>
                 </tr>
                 <tr>
                   <td>Posted On</td><td>:</td><td><?= $det->create_date ?></td>
                 </tr>
                  <tr>
                   <td>State</td><td>:</td><td><?= getTicketStateByCode($det->state,'name') ?></td>
                 </tr>  
               </table> -->
              </div>
              ...
              <div class="t_view_both clearfix">
               <ul class="pd_left">
                    ...
                    <li><strong><?php echo $this->lang->line('Posted');?> : </strong><?= smartdate($det->create_date) ?></li>
               </ul>
                ...
                <?php
                 ...
                 ?>
                  >
                    ...
                    <?php } ?>
                    <li><strong><?php echo $this->lang->line('Posted');?> : </strong><?= smartdate($query->date) ?></li>
               </ul>
               <?php
                  }
                } ?>
