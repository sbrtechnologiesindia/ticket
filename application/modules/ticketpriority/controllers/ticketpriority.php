...
class ticketpriority extends MX_Controller {
	...
	public function insert()
	{
		...
		$this->form_validation->set_rules('priority_name', 'Priority Name', 'required|is_unique['.getDbPrefix().'ticket_priority.priority_name]');
		
		$this->form_validation->set_rules('priority_color', 'Priority color', 'required|is_unique['.getDbPrefix().'ticket_priority.priority_color]|color_check');
