...
class chat extends MX_Controller {
	...
	{
		$data['userlist']=getUserlistChat();
		$this->load->view('showchat',$data);
	}
	
	public function adminchat()
	{
		$data['adminlist']=getAdminlistChat();
	...
	public function addchat()
	{
		...
		$chatrow=$this->input->post('chatrow');
		
		$data['toid']=$toid;
		$data['fromid']=$fromid;
		
		$data['fromemail']=getUserInfoById($fromid)->email;
	...
	public function getchatall()
	{
		...
		$data['toemail']=getUserInfoById($toid)->email;
		$data['fromemail']=getUserInfoById($fromid)->email;
