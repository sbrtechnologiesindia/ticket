...
?>
       ...
       <div class="page_title">
         ...
         <div class="right_panel">
           ...
           <?php if(check_privilege($_SESSION['userid'],'AT')){ ?>
          ...
          <?php if(check_privilege($_SESSION['userid'],'TTAA')){ ?>
          ...
          <?php if(check_privilege($_SESSION['userid'],'ATTA')){ ?>
	...
	<?php $this->load->view('common/ticketpanel');?>
     ...
     <tr>
        ...
        <?php
          $timesettings = (array)getSettingsValue('ticket_time');
			...
			<tr <?php if($i%2==0) { ?> class="white" <?php } else  { ?> class="gray" <?php } ?>>
              ...
              <td><?php
               if($timesettings['type'] == 2)
                {
                  $d = smartdate($ticketdetlist->create_date); 
               ...
               ?></td>
			     <td>	
				     <?php if(check_privilege($_SESSION['userid'],'ET')){ ?>
             <button type="submit" class="edit_button nuc_bl" onclick="window.location.href='<?= TICKET_PLUGIN_URL;?>CI/index.php/ticket/edit/<?php echo $ticketdetlist->id;?>'"><i class="fa fa-pencil"></i><?php echo $this->lang->line('Edit');?></button>
            <?php } ?>
				     <button type="submit" class="edit_button bitn nuc_bl" onclick="window.location.href='<?= TICKET_PLUGIN_URL;?>CI/index.php/ticket/newviewTicket/<?php echo $ticketdetlist->id;?>'"><i class="fa fa-eye"></i><?php echo $this->lang->line('View');?></button>
             <?php if(check_privilege($_SESSION['userid'],'DT')){ ?>
