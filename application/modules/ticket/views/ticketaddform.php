	 ...
	 <?php
	  ...
	  <form action="<?= TICKET_PLUGIN_URL;?>CI/index.php/ticket/insert" method="post" enctype="multipart/form-data">
		...
		<div class="form_holder">
		  ...
		  <input type="text" name="ticket_no" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Ticket No');?>" value="<?= create_guid(); ?>" readonly="">
		</div>
		
		<div class="form_holder">
		  <label><span><?php echo $this->lang->line('Subject');?></span></label>
		  <input type="text" name="subject" placeholder="<?php echo $this->lang->line('Enter');?> <?php echo $this->lang->line('Subject');?>" value="<?php echo set_value('subject');?>">
		</div>
