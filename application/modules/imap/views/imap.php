<?php $this->load->view('common/header'); ?>
       ...
       <div class="page_title">
         <div class="headline">
          <h1><span><i class="fa fa-envelope"></i></span><?php echo $this->lang->line('Email Ticket');?></h1>
         </div>
	              		...
	              		<?php 
	              			if(!empty($emails))
	              			{
	              				foreach($emails as $email){
	              					...
	              					$txt = (check_already_posted($email->eid)) ? "<strong class='scanthreat has-tip' title=\"Already posted as ticket\">[P]</strong>" : "";
