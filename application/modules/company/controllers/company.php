...
class company extends MX_Controller {
	...
	{	
		$this->form_validation->set_rules('company_name', 'Company Name', 'required|is_unique['.getDbPrefix().'company.company_name]');
		$this->form_validation->set_rules('company_website', 'Company Website', 'required|valid_url_format|is_unique['.getDbPrefix().'company.company_website]');
