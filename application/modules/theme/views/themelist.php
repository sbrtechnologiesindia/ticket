  ...
  <span class="spany">Date</span>  
       ...
       <tbody>
          ...
          if($themedetlist->id != 1)
          {
				    ...
				    {
				    ?>
				     <button type="submit" class="edit_button nuc_bl" onclick="window.location.href='<?= TICKET_PLUGIN_URL;?>CI/index.php/theme/edit/<?php echo $themedetlist->id;?>'"><i class="fa fa-pencil"></i><?php echo $this->lang->line('Edit');?></button>
				    <?php
				    }
				    ?>
