       ...
       <div class="page_title">
         ...
         <div class="right_panel">
           ...
           <a id="backupNow" href="<?= TICKET_PLUGIN_URL;?>CI/index.php/backup/doBackup" class="bttn pi-btn btn-no-border"><span class="edit_all"><i class="fa fa-database"></i></span><?php echo $this->lang->line('Backup Now');?></a>
            ...
            <?php if(!is_dir_empty(TICKET_PLUGIN_PATH.'/backup/')){ ?>
            ...
            <?php if(!is_dir_empty(TICKET_PLUGIN_PATH.'/CI/assets/attachments/')){ ?>
		  ...
		  if(!empty($backups))
		  {
			...
			<tr <?php if($i%2==0) { ?> class="white" <?php } else  { ?> class="gray" <?php } ?>>
			     ...
			     <td>	
				     ...
				     {
				    ?>
				     <button type="submit" class="edit_button bitn nuc_bl" onclick="getConfirmation('<?php echo $this->lang->line('Are you sure you want to Restore this backup .All current data will be erased');?>','<?= TICKET_PLUGIN_URL;?>CI/index.php/backup/restorebackup/<?php echo $backup['name'];?>')" ><i class="fa fa-bolt"></i><?php echo $this->lang->line('Restore');?></button>
				     <button type="submit" class="edit_button bitn nuc_bl" onclick="getConfirmation('<?php echo $this->lang->line('Are you sure you want to delete this backup Permenantly.');?>','<?= TICKET_PLUGIN_URL;?>CI/index.php/backup/deletebackup/<?php echo $backup['name'];?>')"><i class="fa fa-trash-o"></i><?php echo $this->lang->line('Delete');?></button>
				     <?php
				     }
				     ?>
             <button type="submit" class="edit_button bitn nuc_bl" onclick="getConfirmation('<?php echo $this->lang->line('Progress to download');?>','<?= TICKET_PLUGIN_URL;?>CI/index.php/backup/downloadbackup/<?php echo $backup['name'];?>')"><i class="fa fa-download"></i><?php echo $this->lang->line('Download');?></button>
