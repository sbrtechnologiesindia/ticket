...
?>
       ...
       <div class="page_title">
         ...
         <div class="right_panel">
           ...
           <a href="<?= TICKET_PLUGIN_URL;?>CI/index.php/users/add" class="bttn pi-btn btn-no-border"><span class="edit_all"><i class="fa fa-plus"></i></span><?php echo $this->lang->line('Add User');?></a>
     ...
     <tbody>		   
		  ...
		  if(!empty($userdet))
		  {
			...
			<tr <?php if($i%2==0) { ?> class="white" <?php } else  { ?> class="gray" <?php } ?>>
			     ...
			     <td><?php echo stripslashes(getPrivilegeGroupById($userdetlist->privilege_group_id,'privilege_name'));?>
           </td>
				...
				<?php if(admin_check($userdetlist->id,$_SESSION['userid'])) { ?>
