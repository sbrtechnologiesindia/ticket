...
?>
    ...
    <div class="form_holder">
      ...
      <!--</select>-->
      <!--</div>-->
      <input style="" type="text" name="mobile" placeholder="<?php echo $this->lang->line('Enter Mobile');?>" value="<?= set_value('mobile'); ?>" value="<?= $det->mobile; ?>" readonly="true">
        ...
        ?>
         <div class="form_holder">
                 ...
                 <select name="privilege_group_id">
                  ...
                  <?php
                  $privilegegroups = getPrivilegeGroups();
