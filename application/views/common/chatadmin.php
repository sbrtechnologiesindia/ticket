...
<div id="showchat" class="chatcover height" style="margin-right: -200px;">
       ...
       <?php echo $this->lang->line('Online Admins');?> <?php if($ccount>0) { echo "(".$ccount.")"; } ?>
       </div>
       ...
       <ul class="content">
           ...
           ?>
           <li>
               <div class="image_placeholder"><img src="<?= getGravatar($adminlistsingle->email);?>" /></div>
               <div class="name_placeholder" onclick="showchatbox('<?php echo $adminlistsingle->id;?>')"><?php echo $adminlistsingle->username;?> <?php if($adminlistsingle->privilege_group_id==1) { echo "(SA)"; } ?></div>
...
if(!empty($adminlist))
{
       ...
       <div id="divforchatbox">
	      ...
	      <div class="chat_box" id="chatboxindividual<?php echo $adminlistsingle->id;?>" style="display: none;">
		    <div class="name" id="name<?php echo $adminlistsingle->id;?>"><div class="on_off <?php if($adminlistsingle->online_status==1) { ?> online <?php } if($adminlistsingle->online_status==0) { ?> offline <?php } ?>"></div><?php echo $adminlistsingle->username;?> <?php if($adminlistsingle->privilege_group_id==1) { ?> (SA) <?php } ?>
