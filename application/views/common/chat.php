...
if(!empty($loginid))
{
       ...
       <div id="showchat" class="chatcover height" style="margin-right: -200px;">
              ...
              <?php echo $this->lang->line('Online Users');?> <?php if($ccount>0) { echo "(".$ccount.")"; } ?>
              </div>
              ...
              <ul class="content">
                  ...
                  foreach($userlist as $userlistsingle)
                  {
                     if($userlistsingle->admin==1)
                     {
                            ...
                            ?>
                            <li>
                                <div class="image_placeholder"><img src="<?= getGravatar($userlistsingle->email);?>" /></div>
                                <div class="name_placeholder" onclick="showchatbox('<?php echo $userlistsingle->id;?>')"><?php echo $userlistsingle->username;?> <?php if($userlistsingle->privilege_group_id==1) { echo "(SA)"; } ?></div>
       ...
       if(!empty($userlist))
       {
              ...
              foreach($userlist as $userlistsingle)
              {
                     ...
                     <div class="chat_box" id="chatboxindividual<?php echo $userlistsingle->id;?>" style="display:none;">
                            ...
                            {
                            ?>
                            <div class="on_off <?php if($userlistsingle->online_status==1) { ?> online <?php } if($userlistsingle->online_status==0) { ?> offline <?php } ?>"></div><?php echo $userlistsingle->username;?> <?php if($userlistsingle->privilege_group_id==1) { echo "(SA)"; } ?>
                            <?php
                            }
                            else
                            {
                           ...
                           <div id="totalchat<?php echo $userlistsingle->id;?>" class="chat_chat">
                              ...
                              <ul id="listchat<?php echo $userlistsingle->id;?>">
                                   ...
                                   $fromid=$loginid;
                                   $chatdet=getChatsbtwnAdminUsers($toid,$fromid);
                                   if(!empty($chatdet))
                                   {
                                          foreach($chatdet as $chatdetlist)
                                          {
                                                 ...
                                                 <li <?php if($fromid==$chatdetlist->from_userid) { ?> class="me" <?php } ?>>
                                                        <div class="image_placeholder"><img src="<?php echo getGravatar($userlistsingle->email);?>" /></div>
                                                        <div class="chat_txt">
